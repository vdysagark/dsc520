...
person_df1 <- read.csv("data/tidynomicon/person.csv", header = TRUE)
...
person_df2 <- read.csv("data/tidynomicon/person.csv",  
...
scores_df <- read.csv("data/scores.csv" , stringsAsFactors = FALSE, header = TRUE)
...
data_result <- excel_sheets("data/G04ResultsDetail2004-11-02.xls")
